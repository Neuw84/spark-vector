...
/**
 * One Arrow {@link RootAllocator} per JVM; operators create a child allocator per task and close it
 * (after closing every vector they produced) from a task-completion listener.
 */
